  ...
  return (
    <section className='container mx-auto px-[1%] py-20 flex flex-col lg:flex-row items-center text-center lg:text-left gap-20 text-white'>
      ...
      <div className="space-y-3">
        <h2 className='font-conthrax text-[20px] lg:text-[30px]'>WELCOME TO THE DIGITAL EQUESTRIAN REALM.</h2>
        <p className='font-vcr text-[10px] lg:text-[20px]'>Step into the forefront of the digital gaming revolution with DigiHorse, where we’re redefining the landscape of profitability and entertainment. As digital gaming experiences unprecedented growth, we’re pioneering a new era where players can not only enjoy immersive gameplay but also profit from their passion for horse racing through blockchain technology.</p>
      </div>
